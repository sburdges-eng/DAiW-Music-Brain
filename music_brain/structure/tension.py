...
"""
Tension Curve Generator - Bar-by-Bar Emotional Contours

Generates 1D arrays of tension multipliers (~0.5 to ~1.5) for each bar.
These act as automation lanes for velocity / complexity across a song.

Philosophy: Music should have emotional shape, not just static intensity.
The difference between a loop pack and a writing partner is contour.
"""
...
def generate_tension_curve(total_bars: int, structure_type: str = "standard") -> np.ndarray:
    ...
    Args:
        ...
        structure_type: Shape of the tension curve
