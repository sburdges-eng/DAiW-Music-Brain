...
# Numpy is optional - degrade gracefully if not available
try:
    import numpy as np
...
def build_tension_curve(length_bars: int, pattern: str = DEFAULT_PATTERN) -> List[float]:
    ...
    if NUMPY_AVAILABLE:
        ...
        # Fallback: simple 3-point moving average without numpy
        smoothed = []
        for i in range(len(sections)):
            start = max(0, i - 1)
            end = min(len(sections), i + 2)
            avg = sum(sections[start:end]) / (end - start)
            smoothed.append(avg)
        return smoothed
...
# ==============================================================================
# 8. LYRIC MIRROR (Cut-up / Markov fragments)
# ==============================================================================
...
# ==============================================================================
# 9. KIT SELECTION (Mood -> Sample Kit)
# ==============================================================================
...
# ==============================================================================
# 10. CLI HANDLER (The "View" Layer) - Optional
# ==============================================================================
